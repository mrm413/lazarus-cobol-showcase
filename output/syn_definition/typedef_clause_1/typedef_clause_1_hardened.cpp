...
FixedString<50> amount;
FixedString<30> ausgabe_file_name;
FixedString<50> detail_no;
FixedString<100> message_text_2;
FixedString<30> output_name;
int RETURN_CODE = 0;
FixedString<50> SA;
FixedString<80> some2_data;
FixedString<50> some2_index;
