...
std::string VAR_15; // Auto-declared by LAZARUS healer
...
FixedString<50> a;
FixedString<50> b;
FixedString<10> json_len;
FixedString<50> normal_str;
FixedString<50> short_str;
...
void p_main() {
    ...
    // UNHANDLED: cob_json_generate_new (&f_21, &mt_7, nullptr, 46);
    if (false /* EXCEPTION 0x1700 */) {
