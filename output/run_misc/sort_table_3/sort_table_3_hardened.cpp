...
int RETURN_CODE = 0;
FixedString<50> row2;
FixedString<50> tab1_nr;
FixedString<50> tab2_nr;
...
void p_a() {
    ...
    // UNHANDLED: cob_table_sort (COB_SET_FLD (f0, 7, b_19, &a_2), (*(unsigned int *)(b_18)));
    K = "01";
    while (true) {
        if (to_int(K) > 4) break;
        std::cout << std::endl;
    ...
    // UNHANDLED: cob_table_sort_init (1, 0);
    // UNHANDLED: cob_table_sort_init_key (&f_24, 0, 0);
