...
FixedString<50> binfld5;
FixedString<50> binfld5s;
FixedString<50> binfld9;
FixedString<50> chrx;
FixedString<50> comp3;
FixedString<50> comp3v99;
FixedString<50> grpx;
FixedString<50> NE;
FixedString<50> pic9;
int RETURN_CODE = 0;
...
void p_main() {
    ...
    std::cout << " 1: BINARY   BY VALUE     S9(9)       2560;" << std::endl;
    std::cout << " 2: DISPLAY  BY VALUE     9(2)        16;" << std::endl;
    std::cout << "CAPI called with 2 parameters" << std::endl;
    std::cout << " 1: BINARY   BY REFERENCE 9(5)        1280;" << std::endl;
    std::cout << " 2: EDITED   BY REFERENCE S9(5)V9(2)  -51277  to   511.47 ;" << std::endl;
    std::cout << "CAPI called with 1 parameters" << std::endl;
    std::cout << " 1: BINARY   BY REFERENCE S9(5)       1024;" << std::endl;
    std::cout << "CAPI called with 1 parameters" << std::endl;
    std::cout << " 1: BINARY   BY REFERENCE 9(9)        2560;" << std::endl;
    std::cout << "CAPI called with 2 parameters" << std::endl;
    std::cout << " 1: COMP-3   BY REFERENCE 9(8)        4096;" << std::endl;
    std::cout << " 2: EDITED   BY REFERENCE S9(5)V9(2)  51277  to   514.07-;" << std::endl;
    std::cout << "CAPI called with 4 parameters" << std::endl;
    std::cout << " 1: DISPLAY  BY REFERENCE S9(8)       8192;" << std::endl;
    std::cout << " 2: BINARY   BY REFERENCE S9(5)       1027;" << std::endl;
    ...
    std::cout << " 1: COMP-3   BY REFERENCE 9(8)        4099;" << std::endl;
    std::cout << " 2: EDITED   BY REFERENCE S9(5)V9(2)  -51407  to   512.77 ;" << std::endl;
    std::cout << " 3: X        BY REFERENCE X(9)        'Bye!';" << std::endl;
    std::cout << "CAPI called with 2 parameters" << std::endl;
    std::cout << " 1: BINARY   BY REFERENCE 9(5)        1283;" << std::endl;
    std::cout << " 2: EDITED   BY REFERENCE S9(5)V9(2)  51277  to   514.07-;" << std::endl;
    std::cout << "CAPI called with 2 parameters" << std::endl;
    std::cout << " 1: BINARY   BY REFERENCE 9(5)        1286;" << std::endl;
    std::cout << " 2: X        BY VALUE     X(9)        'Hello!';" << std::endl;
    std::cout << "CAPI called with 2 parameters" << std::endl;
    std::cout << " 1: BINARY   BY REFERENCE 9(5)        1289;" << std::endl;
    std::cout << " 2: X        BY VALUE     X(9)        'Hello!';" << std::endl;
    std::cout << "CAPI called with 1 parameters" << std::endl;
    std::cout << " 1: BINARY   BY VALUE     S9(9)       18;" << std::endl;
    std::cout << "CAPI called with 2 parameters" << std::endl;
    ...
    std::cout << " 2: COMP-3   BY REFERENCE 9(8)        4102;" << std::endl;
    std::cout << "CAPI called with 1 parameters" << std::endl;
    std::cout << " 1: COMP-3   BY REFERENCE S9(7)V9(2)  1250;" << std::endl;
