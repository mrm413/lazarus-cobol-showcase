...
void p_main() {
    std::cout << "TST-NUMBER IS NOT ZERO-NUMBER" << std::endl;
    std::cout << "TST-NUMBER IS < ZERO-NUMBER" << std::endl;
    std::cout << "TST-DECIMAL IS NOT ZERO-DECIMAL" << std::endl;
    std::cout << "TST-DECIMAL IS < ZERO-DECIMAL" << std::endl;
}
