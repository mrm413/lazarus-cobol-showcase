 ...
 * Source: end_key_preprocessed.cbl
 * Program: prog
 */
...
void P_MAIN() {
    std::cout << "Enter 'y' if multiple presses of the END key" << "1" << "1" << std::endl;
    std::cout << "go to the end of the field and just after the end" << "2" << "1" << std::endl;
