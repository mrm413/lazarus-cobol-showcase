 ...
 * Source: home_key_preprocessed.cbl
 * Program: prog
 */
...
void P_MAIN() {
    std::cout << "Enter 'y' if multiple presses of the HOME key" << "1" << "1" << std::endl;
    std::cout << "go to the beginning of the field and the beginning" << "2" << "1" << std::endl;
    std::cout << "of the characters." << "3" << "1" << std::endl;
    ws_x_20 = "    ABC";
