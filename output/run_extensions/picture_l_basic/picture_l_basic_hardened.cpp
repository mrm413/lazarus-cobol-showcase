...
FixedString<50> lgy;
int RETURN_CODE = 0;
FixedString<80> w_data;
FixedString<10> w_len;
FixedString<50> w_nested;
...
FixedString<50> x_grp;
FixedString<50> z_grp;
FixedString<50> z_v;
...
void p_main() {
    ...
    lgx.at(4) = static_cast<char>(57);
    lgx.at(4) = static_cast<char>(53);
    lgx.at(4) = static_cast<char>(57);
    if (false /* cob_cmp != 0 */) {
