...
std::string c_25; // Auto-declared by LAZARUS healer

std::string c_24; // Auto-declared by LAZARUS healer

std::string c_23; // Auto-declared by LAZARUS healer

std::string c_22; // Auto-declared by LAZARUS healer

std::string c_21; // Auto-declared by LAZARUS healer

std::string c_20; // Auto-declared by LAZARUS healer

std::string c_19; // Auto-declared by LAZARUS healer

std::string c_18; // Auto-declared by LAZARUS healer

std::string VAR_27; // Auto-declared by LAZARUS healer

std::string c_16; // Auto-declared by LAZARUS healer
...
std::string c_4; // Auto-declared by LAZARUS healer
...
FixedString<50> compute_1;
FixedString<50> if_d16;
FixedString<50> pic_9_decimal;
FixedString<50> pic_9_not_decimal;
FixedString<50> pic_9_not_signed;
FixedString<50> pic_9_signed;
FixedString<50> pic_9_signed_decimal;
int RETURN_CODE = 0;
FixedString<15> ws_line_number;
FixedString<15> ws_number;
FixedString<100> ws_text;
