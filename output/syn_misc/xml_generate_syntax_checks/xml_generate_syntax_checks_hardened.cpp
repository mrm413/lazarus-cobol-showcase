...
FixedString<50> all_filler_rec;
FixedString<100> bool_area;
FixedString<50> child_1;
FixedString<50> float_item;
FixedString<8> invalid_sub_elt_rec;
FixedString<50> just_item;
FixedString<50> long_str;
FixedString<50> pic_p_item;
FixedString<50> str_1;
FixedString<100> table_area;
