...
void p_main() {
    std::cout << "INIT X-1 : 00091 ." << std::endl;
    std::cout << "INIT X-2 : 00092 ." << std::endl;
    std::cout << "INIT X-4 : 00128 ." << std::endl;
    std::cout << "INIT D-1 : 00095 ." << std::endl;
    std::cout << "MOVE X-1 : 00095 ." << std::endl;
    std::cout << "MOVE X-2 : 00095 ." << std::endl;
    std::cout << "MOVE X-4 : 00256 ." << std::endl;
    std::cout << "MOVE D-1 : 00095 ." << std::endl;
    std::cout << "MOVE X-1 : 00193:01930 ." << std::endl;
    std::cout << "MOVE X-2 : 00193:01930 ." << std::endl;
}
