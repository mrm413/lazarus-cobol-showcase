...
void p_main() {
    ...
    // UNHANDLED: cob_start (h_FILE1, 4, &f_18, nullptr, nullptr);
    if (file_status != "EXCEPTION_0") {
    }
    // READ NEXT FILE1
    if (file_status != "EXCEPTION_0") {
    ...
    file1_key = "099";
    // UNHANDLED: cob_start (h_FILE1, 2, &f_18, nullptr, nullptr);
    if (file_status != "EXCEPTION_0") {
    }
    // READ NEXT FILE1
    if (file_status != "EXCEPTION_0") {
    ...
    // UNHANDLED: cob_start (h_FILE1, 7, &f_18, nullptr, nullptr);
    if (file_status != "EXCEPTION_0") {
    }
    // READ NEXT FILE1
    if (file_status != "EXCEPTION_0") {
    ...
    file1_key = std::string(3, '0');
    // UNHANDLED: cob_start (h_FILE1, 8, &f_18, nullptr, nullptr);
    if (file_status != "EXCEPTION_0") {
    }
    // READ NEXT FILE1
    if (file_status != "EXCEPTION_0") {
    ...
    file1_key = std::string(3, '0');
    // UNHANDLED: cob_start (h_FILE1, 5, &f_18, nullptr, nullptr);
    if (file_status != "EXCEPTION_0") {
    }
    // READ NEXT FILE1
    if (file_status != "EXCEPTION_0") {
    ...
    file1_key = "099";
    // UNHANDLED: cob_start (h_FILE1, 3, &f_18, nullptr, nullptr);
    if (file_status != "EXCEPTION_0") {
    }
    // READ NEXT FILE1
    if (file_status != "EXCEPTION_0") {
