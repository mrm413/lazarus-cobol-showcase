...
void p_main() {
    std::cout << "EXFTH did OPEN_IN; Status=35; File now Closed" << std::endl;
    std::cout << "Open Input when no file Sts:35" << std::endl;
    std::cout << "EXFTH did OPEN_EXT; Status=35; File now Closed" << std::endl;
    std::cout << "Open Extend when no file Sts:35" << std::endl;
    std::cout << "EXFTH did CLOSE; Status=42; File now Closed" << std::endl;
    std::cout << "Close when no open file Sts:42" << std::endl;
    std::cout << "EXFTH did OPEN_OUT; Status=00; File now Open" << std::endl;
    std::cout << "EXFTH did CLOSE; Status=00; File now Closed" << std::endl;
    std::cout << "EXFTH did OPEN_EXT; Status=00; File now Open" << std::endl;
    std::cout << "Open Extend when empty file Sts:00" << std::endl;
    std::cout << "EXFTH did CLOSE; Status=00; File now Closed" << std::endl;
    std::cout << "Loading sample data file." << std::endl;
    std::cout << "EXFTH did OPEN_OUT; Status=00; File now Open" << std::endl;
    std::cout << "EXFTH did WRITE; Status=00" << std::endl;
    std::cout << "EXFTH did WRITE; Status=00" << std::endl;
    std::cout << "EXFTH did WRITE; Status=00" << std::endl;
    std::cout << "EXFTH did WRITE; Status=00" << std::endl;
    std::cout << "EXFTH did WRITE; Status=00" << std::endl;
    ...
    std::cout << "EXFTH did CLOSE; Status=00; File now Closed" << std::endl;
    std::cout << "EXFTH did OPEN_IN; Status=00; File now Open" << std::endl;
    std::cout << "Open Sts:00" << std::endl;
    std::cout << "EXFTH did READ_SEQ; Status=00" << std::endl;
    std::cout << "Read ALP00000 Sts:00" << std::endl;
    std::cout << "EXFTH did READ_SEQ; Status=00" << std::endl;
    std::cout << "Read BET00000 Sts:00" << std::endl;
    std::cout << "EXFTH did CLOSE; Status=00; File now Closed" << std::endl;
    std::cout << "EXFTH did OPEN_IO; Status=00; File now Open" << std::endl;
    std::cout << "EXFTH did READ_SEQ; Status=00" << std::endl;
    std::cout << "Read ALP00000 Sts:00" << std::endl;
    std::cout << "EXFTH did REWRITE; Status=00" << std::endl;
    ...
    std::cout << "EXFTH did READ_SEQ; Status=00" << std::endl;
    std::cout << "Read BET00000" << std::endl;
    std::cout << "EXFTH did CLOSE; Status=00; File now Closed" << std::endl;
    std::cout << "EXFTH did OPEN_IN; Status=00; File now Open" << std::endl;
    std::cout << "Re-list File Open Sts:00" << std::endl;
    std::cout << "EXFTH did READ_SEQ; Status=00" << std::endl;
    std::cout << "Read  ALP00000 Trms:0012" << std::endl;
    std::cout << "EXFTH did READ_SEQ; Status=00" << std::endl;
    std::cout << "Read  BET00000 Trms:0013" << std::endl;
    std::cout << "EXFTH did READ_SEQ; Status=00" << std::endl;
    std::cout << "Read  GAM00000 Trms:0075" << std::endl;
    std::cout << "EXFTH did READ_SEQ; Status=00" << std::endl;
    std::cout << "Read  DEL00000 Trms:0010" << std::endl;
    std::cout << "EXFTH did READ_SEQ; Status=00" << std::endl;
    std::cout << "Read  EPS00000 Trms:0090" << std::endl;
    std::cout << "EXFTH did READ_SEQ; Status=00" << std::endl;
    std::cout << "Read  FOR00000 Trms:0254" << std::endl;
    std::cout << "EXFTH did READ_SEQ; Status=10" << std::endl;
    ...
    std::cout << "EXFTH did CLOSE; Status=00; File now Closed" << std::endl;
    std::cout << "EXFTH did OPEN_IN; Status=00; File now Open" << std::endl;
    std::cout << "List File afer EXTEND Open Sts:00" << std::endl;
    std::cout << "EXFTH did READ_SEQ; Status=00" << std::endl;
    std::cout << "Read  ALP00000 Trms:0012" << std::endl;
    std::cout << "EXFTH did READ_SEQ; Status=00" << std::endl;
    std::cout << "Read  BET00000 Trms:0013" << std::endl;
