...
std::string VAR_53; // Auto-declared by LAZARUS healer

std::string VAR_62; // Auto-declared by LAZARUS healer
...
FixedString<50> acb_cnt;
FixedString<50> E4;
FixedString<50> E6;
FixedString<20> key_def_area;
FixedString<20> key_def_len;
FixedString<20> number_of_keys;
FixedString<50> off1;
FixedString<50> off2;
FixedString<80> program_data;
int RETURN_CODE = 0;
