...
void p_main() {
    std::cout << "(a   ) 00" << std::endl;
    std::cout << "(ab  ) 00" << std::endl;
    std::cout << "(abc ) 00" << std::endl;
    std::cout << "(abcd) 00" << std::endl;
    std::cout << "(abcd) 06" << std::endl;
    std::cout << "(e   ) 00" << std::endl;
    std::cout << "(abcd) 06" << std::endl;
    std::cout << "(ef  ) 00" << std::endl;
    std::cout << "(ef  ) 10" << std::endl;
}
