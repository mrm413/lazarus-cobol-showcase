 ...
 * Source: start_relative_3_preprocessed.cbl
 * Program: prog
 */
...
void P_MAIN() {
    ...
    // UNHANDLED: cob_start (h_FILE1, 4, &f_19, NULL, NULL);
    if (file_status != "EXCEPTION_0") {
    }
    // READ NEXT FILE1
    if (file_status != "EXCEPTION_0") {
    ...
    file1_key = "000099";
    // UNHANDLED: cob_start (h_FILE1, 2, &f_19, NULL, NULL);
    if (file_status != "EXCEPTION_0") {
    }
    // READ NEXT FILE1
    if (file_status != "EXCEPTION_0") {
    ...
    file1_key = std::string(6, '0');
    // UNHANDLED: cob_start (h_FILE1, 7, &f_19, NULL, NULL);
    if (file_status != "EXCEPTION_0") {
    }
    // READ NEXT FILE1
    if (file_status != "EXCEPTION_0") {
    ...
    file1_key = std::string(6, '0');
    // UNHANDLED: cob_start (h_FILE1, 8, &f_19, NULL, NULL);
    if (file_status != "EXCEPTION_0") {
    }
    // READ NEXT FILE1
    if (file_status != "EXCEPTION_0") {
    ...
    file1_key = std::string(6, '0');
    // UNHANDLED: cob_start (h_FILE1, 5, &f_19, NULL, NULL);
    if (file_status != "EXCEPTION_0") {
    }
    // READ NEXT FILE1
    if (file_status != "EXCEPTION_0") {
    ...
    file1_key = "000099";
    // UNHANDLED: cob_start (h_FILE1, 3, &f_19, NULL, NULL);
    if (file_status != "EXCEPTION_0") {
    }
    // READ NEXT FILE1
    if (file_status != "EXCEPTION_0") {
