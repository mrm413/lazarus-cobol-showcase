...
FixedString<30> file_name;
FixedString<15> flat_num;
FixedString<50> flat_record;
FixedString<50> flat_stat;
FixedString<15> rec_num;
int RETURN_CODE = 0;
FixedString<30> the_file_name;
...
int main() {
    std::cout << "OPEN I-O: file1+file2+file3                                Sts:35" << std::endl;
    std::cout << "OPEN INPUT: file1&file2&file3                                Sts:35" << std::endl;
}
// ============================================================================
